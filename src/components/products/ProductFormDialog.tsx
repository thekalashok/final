...
export default function ProductFormDialog({ open, onOpenChange, product, onSave, onDelete }: ProductFormDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg rounded-[2rem] p-0 border-none shadow-2xl overflow-hidden flex flex-col max-h-[95vh]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden">
          <div className="p-8 pt-6 space-y-5 overflow-y-auto flex-grow">
          ...
          <DialogFooter className="p-8 pt-4 flex flex-col sm:flex-row gap-3 border-t border-slate-50 flex-shrink-0">
            {product && onDelete && (
              <Button 
                type="button" 
                variant="outline" 
